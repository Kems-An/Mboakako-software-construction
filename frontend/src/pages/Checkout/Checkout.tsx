...
// Checkout page — creates order then redirects to Stripe (via Supabase Edge Function)
// or falls back to direct order placement if Stripe is not configured.
    ...
    <main className="min-h-screen bg-gray-50 py-10">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 text-sm text-amber-800">
          <strong>Payment:</strong> This project uses a simulated checkout. In production,
          connect a Supabase Edge Function to Stripe to handle real payment processing.
        </div>
